...
class SalarySetScreen extends StatefulWidget {
  @override
  _SalarySetScreenState createState() => _SalarySetScreenState();
}

class _SalarySetScreenState extends State<SalarySetScreen> {
  final TextEditingController _employeeIdController = TextEditingController();
  final TextEditingController _employeeNameController = TextEditingController();
  final TextEditingController _salaryController = TextEditingController();

  final Map<String, Map<String, String>> _salaries = {};
  ...
  void _submitSalary() {
    ...
    if (employeeId.isNotEmpty && employeeName.isNotEmpty && salary.isNotEmpty) {
      setState(() {
        _salaries[employeeId] = {
          'name': employeeName,
          'salary': salary,
        };
        _employeeIdController.clear();
